package com.example.myapplication.myLib;
...
public class MyRequestPermission{
    ...
    public void register(){
        requestPermissionLauncher = componentActivity.registerForActivityResult(new ActivityResultContracts.RequestPermission(), isGranted -> {
            if (isGranted) {
